...
declare module "transmission" {
        ...
        type callback = (err: Error, results: results) => void;
        ...
        class Transmission {
                 ...
                 */
                set(ids: number[] | number, options: setTorrentOptions, callback: callback): void;
                ...
                addFile(filePath: string, options: options, callback: callback): void;
                 ...
                 * @param options (optional) options as defined by the RCP spec @ https://trac.transmissionbt.com/browser/trunk/extras/rpc-spec.txt
                 */
                addUrl(url: string, options: options, callback: callback): void;
                 ...
                 * @param options (optional) options as defined by the RCP spec @ https://trac.transmissionbt.com/browser/trunk/extras/rpc-spec.txt
                 */
                session(options: setSessionOptions, callback: callback): void;
